...
<div id="footerIndex">
    ...
    <ul>
        ...
        <div id="pagseguro">
                ...
                <input type="hidden" name="receiverEmail" value="leoneramos83@hotmail.com" />
        ...
        <h2><em>PayPal</em></h2>
            <form action="https://www.paypal.com/donate" method="post" target="_top">
                ...
                <img alt="Doe com PayPay" src="https://www.paypal.com/en_BR/i/scr/pixel.gif" width="1" height="1" />
            </form>
        </div>
